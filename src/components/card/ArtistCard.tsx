...
export default function ArtistCard(props: ArtistCardProps) {
  return (
    <a href="/" className="artist-card flex justify-center items-center gap-10 h-32 w-72 xl:mx-auto bg-neutral-800 text-rose-500 hover:bg-rose-500 hover:text-white ease-out duration-300">
