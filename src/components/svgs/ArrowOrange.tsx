...
export default function ArrowOrange(props: SvgInterface) {
  return (
    <svg width={props.width} height={props.height} viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
